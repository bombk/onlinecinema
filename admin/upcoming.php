...
<div class="content">
		<h1>Add New Up Coming Movie Details</h1>
		<p>Here you can do stuff</p>
		<div id="box">
			<div class="box-top"><h2>Add New Up Coming Movie</h2></div>
			<div class="box-panel">
				...
				<form action="upcoming.php" method="POST" enctype="multipart/form-data">
					<table class="table">
						...
						<tr>
							<td>Movie Details:</td>
							<td><textarea name="details" cols="43" rows="6" placeholder="Enter Movie Details." required></textarea></td>
						</tr>
						<tr>
...
<?php
	...
	if(isset($_POST["submit1"]))
	{
		...
		$sql="INSERT INTO upcomingMovie (movieId,movieName,genre,cast,poster,releaseDate,details)
		VALUES('$movieId','$movieName','$genre','$cast','$poster','$releaseDate','$details')";
