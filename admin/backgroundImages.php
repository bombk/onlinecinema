...
<div class="content">
		<h1>Add New Background Movie Details</h1>
		<p>Here you can do stuff</p>
		<div id="box">
			<div class="box-top"><h2>Add New Background Movie</h2></div>
			<div class="box-panel">

				<form action="backgroundImages.php" method="POST" enctype="multipart/form-data">
					<table class="table">
						<tr>
							<td>Movie Id:</td>
...
<?php
	...
	if(isset($_POST["submit1"]))
	{
		...
		$sql="INSERT INTO backgrounddetails (movieId,movieName,genre,cast,showTime,poster,movieDetails)
