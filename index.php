			...
			<nav id="nav">
				<div class="container">
					<div class="nav-holder">
						<div class="logo">
							<a href="index.php"><img src="images/logo.png" alt="BOM"></a>
						</div>
						<ul class="navbar-right">
							...
							<li>
								...
								<div class="login-block">
									<span class="login-opener icon-close"></span>
									<form action="include/logIn.php" class="login-form" method="POST">
										<input type="text" name="userName" placeholder="Username/Mobile" required>
										<input type="password" name="password" placeholder="Password" required>
										<input type="submit" value="Log In"/>
									</form>
							
									<p>Not a member yet? <span class="block-toggle"><a href="signup1.php">Click Here!</a></span> to Sign Up.</p>
								</div>
							</li>
						</ul>
						...
						<?php
									...
									$result=$conn->query($sql);
										while($row=mysqli_fetch_array($result)){
											...
											echo "<li><span class='icon-ticket'></span><a href='signup1.php'><span>Buy Tickets</span></a></li>";
											echo "</ul>";
						...
						<div class="carousel-wrap">
							...
							?>
										<ul class="item-buy">
											...
											<li><span class="icon-ticket"></span><a href="signup1.php"><span>Buy Tickets</span></a></li>
										</ul>
									</div>
								</div>
							</div>
						...
						<div class="carousel-wrap">
								...
								?>
										<ul class="item-buy">
											...
											<!-- <li><span class="icon-ticket"></span><a href="seat.html"><span>Buy Tickets</span></a></li> -->
										</ul>
									</div>
								</div>
							</div>
